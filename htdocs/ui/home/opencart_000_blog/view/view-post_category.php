<div class="container">
  <ul class="breadcrumb">
    ...
    <li><a href="/post_category.php">Loại Tin</a></li>
  </ul>
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <?php } ?>
      <?php if (!$categories && !$postsByCategory) { ?>
      <p>Không tìm thấy bài viết nào cho loại này</p>
      <div class="buttons">
        <div class="pull-right"><a href="/home-post.php" class="btn btn-primary">Tiếp tục</a></div>
      </div>
      <?php } ?>
      </div>
    </div>
