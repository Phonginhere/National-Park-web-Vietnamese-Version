/* ScrollMagic v1.0.8 | (c) Jan Paepke, @janpaepke | license & info: http://janpaepke.github.io/ScrollMagic */ ! function($) {
    ScrollMagic = function(e) {
        ...
        var t, i, o, s, a = ["onCenter", "onEnter", "onLeave"],
            ...
            m = function() {
                ...
                if (i && t && u.triggerElement && u.loglevel >= 2) {
                    var n = i.getTweensOf($(u.triggerElement)),
                        r = t.info("vertical");
                    $.each(n, function(e, t) {
                        var n = t.vars.css || t.vars,
                            i = r ? void 0 !== n.top || void 0 !== n.bottom : void 0 !== n.left || void 0 !== n.right;
            ...
            y = function(e) {
                if (o && t) {
                    ...
                    if (e || "DURING" !== d && ("AFTER" !== d || 0 !== u.duration)) {
                        ...
                        var l = r(s.spacer, !0),
                            c = u.reverse || 0 === u.duration ? n.scrollPos - h.start : Math.round(f * u.duration * 10) / 10;
        ...
        return this.parent = function() {
            ...
            if (t) {
                var n = t.info();
                if (null === u.triggerElement) e += n.size * g.triggerHook();
                else {
