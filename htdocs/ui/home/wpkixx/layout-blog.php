...
<html>
   <head>
      ...
      <link rel="stylesheet" href="/ui/home/wpkixx/template_files/fontello.html" type="text/css">
         ...
         <header class="style1">
            <div class="top-bar">
               <div class="container">
                  <div class="current-time"><!-- PHP date() in foreign languages - e.g. Mar 25 Aoû 09 -->
                     ...
                     <span id="clock"><small><?php echo date("d/m/Y");  ?></small></span>
                     <ul>
                        <!-- <li><a href="/blog.php" title="">Blog</a></li> -->
                        <li><a href="/about.php" title=""><i class="fa fa-info"></i>&nbsp;Giới Thiệu</a></li>
                        <li><a href="/contact-blog.php" title=""><i class="fa fa-phone"></i>&nbsp;Liên Hệ</a></li>
                     </ul>
                  </div>
                  ...
                  <ul class="social-btns">
                     ...
                     <?php if ( !isset ($_SESSION['CUS_LOGGED']) ) { // nếu đã đăng nhập ?>
            ...
            <div class="logo-bar" style="background: url(/ui/home/wpkixx/template_files/bg-goexplore-2.jpg)">
               <div class="container">
                  <div class="row">
                     <div class="col-sm-3">
                        <div class="logo"> <!-- thay ảnh logo -->
<!--                            <a title="#" href="#.html"><img alt="headline" src="/ui/home/wpkixx/template_files/logo.png"></a> -->
                            <a title="#" href="/home-blog.php"><!--<img alt="headline" src="/ui/home/wpkixx/template_files/logo-ecopark.png" style="height:90px"> --><IMG height="290" width="284" title="<?php echo web_name(); ?>" class="img-responsive" alt="<?php echo web_name(); ?>" src="<?php echo web_logo_url(); ?>"></a> 
                        </div>
                     </div>
                     <!-- 
                     <div class="col-sm-9">
            ...
            <!-- Menu Bar -->
            <form class="search-here" action="/blog.php" method="post">
               <input type="text" placeholder="Tìm kiếm ..." name="search" style="text-transform: none;">
         ...
         <div class="responsive-header">
            <div class="res-logo-area">
               <div class="col-sm-9 col-xs-6">
                  <a href="#" title=""><IMG title="<?php echo web_name(); ?>" class="img-responsive" alt="<?php echo web_name(); ?>" src="<?php echo web_logo_url(); ?>"></a></h1></a> <!-- sửa -->
               </div>
            ...
            <form class="search-insite" action="/blog.php" method="post">
               <i class="fa fa-close"></i>
...
<!--                                  <h1><a href="#.html" title=""><img src="/ui/home/wpkixx/template_files/logo2.png" alt=""></a></h1> -->
                                 <h1><!--<a href="/home-blog.php" title=""><img src="/ui/home/wpkixx/template_files/logo-ecopark.png" alt=""></a>--><IMG height="290" width="284" title="<?php echo web_name(); ?>" class="img-responsive" alt="<?php echo web_name(); ?>" src="<?php echo web_logo_url(); ?>"></a></h1>
                                 <p>Chúng tôi là những lập trình viên yêu thích công việc phát triển Web Portal với các công nghệ front-end như HTML,CSS, JavaScript, Bootstrap, jQuery; và công nghệ back-end như PHP, MySQL.
                                 </p>
                              </div>
                              <ul class="social">
                        ...
                        <div class="col-md-2 col-sm-4">
                           <div class="widget">
                              <div class="widget-title">
                                 <h4><!--Tin Nổi Bật--> Về Chúng Tôi</h4>
                              </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                           <div class="widget">
                              <div class="widget-title">
                                 <h4><!--Loại Tin Top -->Tin Thư</h4>
                              </div> 
							  <div class="subscribe-us" style="background-color: black; border: 1px solid white;">
                        ...
                        <div class="col-md-4 col-sm-6">
                           <div class="widget">
                              <div class="widget-title">
                                 <h4><!--Tin Mới-->Có Câu Hỏi Đến Chúng Tôi?</h4>
                              </div>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="copyright">
                        ...
                        <h5><span><?php echo web_name();?></span> © <?php echo date('Y');?></h5>
                     </div>
                  </div>
               </div>
            </div>
