                     ...
                     <div class="col-md-3 col-sm-4">
                        <div class="grid-post md3 fadeInup">
                           <div class="post-avatar">
                              ...
                              <img src="<?php echo $new_post['image'] ?>" alt="" style="width: 250px; height: 150px;">
                              </a>
                           </div>
                           <div class="post-data">
                        ...
                        <!--      <div class="widget-title">
                              ...
                              <div class="sidebar-login">
                                 <form method="post" action="/login.php" >
                                    <label>
                                    <input type="text" placeholder="Email*" name="email" value="<?php echo $email; ?>" class="username" style="text-transform: none;">
                                    <i class="fa fa-user"></i>
                                    </label>
                                    <label>
                                    <input type="password" placeholder="Password*" name="password" value="<?php echo $password; ?>" style="text-transform: none;">
                                 ...
                                 <div class="owl-item" style="width: 308px; margin-right: 0px;">
                                    <div class="progress-unit">
                                       ...
                                       <div class="post-progress">
                                          <img src="<?php echo URL_IMAGE.$post['image']?>" alt="" style="width: 308px; height: 200px">
                                       ...
                                       <div class="row">
                                          <div class="col-sm-6"><!-- chẵn -->
                                             <div class="wid-tab-post">
                                                <a href="/blog-post.php?post_id=<?php echo $post['post_id']?>" title=""><img src="<?php echo URL_IMAGE.$post['image']?>" alt="" style="width: 150px; height: 100px"></a>
                           ...
                           <div class="widget">
                              <div class="ad-widget">
                            <a href="https://aptechvietnam.com.vn/"><img src="/ui/home/wpkixx/template_files/Annotation_2020-08-21_095912.jpg" alt=""></a>     
                              </div>
                           </div>
                           <!-- end Ad Widget --> 
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="row remove-ext">
                           ...
                           <div class="col-sm-6">
                              <div class="post-grid-style">
                                 <a href="/blog-post.php?post_id=<?php echo $post['post_id']?>" title="">
                                 	<img src="<?php echo URL_IMAGE.$post['image']?>" alt="" style="width: 350px; height: 200px">
                                 </a>
                                 <div class="post-detail">
                                    <a class="category" href="/post_category.php?path=<?php echo $next_cat_id;?>" title=""><?php echo $next_post_cat['name'] ?></a>
                                    <ul class="stars-rank">
									...
									<p><?php echo utf8_substr(strip_tags(html_entity_decode($post['content'], ENT_QUOTES, 'UTF-8')), 0, 150) . '..' ?></p>
                                 </div>
                              </div>
                           </div>
                           <?php } ?>                        
                           ...
                           <div class="widget">
                              ...
                              <ul class="flickr-widget">
                                 ...
                                 <li><a href="/blog-post.php?post_id=<?php echo $post['post_id']?>" title="">
                                 	<img src="<?php echo URL_IMAGE.$post['image']?>" alt="" width="45" height="1550">
                                 	</a>
                                 </li>
                                 <?php } ?>
                              </ul>
