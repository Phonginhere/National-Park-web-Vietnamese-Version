  ...
  <div class="row"> -->
  	...
  	<column id="column-left" class="col-sm-3 hidden-xs">
		...
		<!--
		  ...
		  <a href="/contact-blog.php" class="list-group-item">Liên Hệ Với Chúng Tôi</a>
    ...
    <div id="content" class="col-sm-9">
	   <h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Chúng Tôi Là Ai???</font></font></h1>
	   <br>
	   <br>
	   <p></p>
