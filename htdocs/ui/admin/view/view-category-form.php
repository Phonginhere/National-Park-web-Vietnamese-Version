  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="/admin/category.php" data-toggle="tooltip" title="Hủy" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
      <ul class="breadcrumb">
      ...
      <div class="panel-body">
        <form action="<?php echo $url_action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li class=""><a href="#tab-data" data-toggle="tab">Dữ Liệu</a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
                <div class="tab-pane" id="language">
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-name">Tên Loại Sản Phẩm</label>
                    <div class="col-sm-10">
                      <input type="text" name="name" value="<?php echo isset($category_name) ? $category_name : ''; ?>" placeholder="Tên loại sản phẩm" id="input-name" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="description" placeholder="Mô tả" id="input-description" class="form-control"><?php echo $category_description; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane fade" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="path" value="<?php echo $category_path; ?>" placeholder="Loại cha" id="input-parent" class="form-control" />
             ...
             -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="keyword" value="<?php echo $category_keyword; ?>" placeholder="SEO Keywords" id="input-keyword" class="form-control" />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"><a href="" id="thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $category_thumb; ?>" alt="" title="" data-placeholder="<?php echo $category_placeholder; ?>" /></a>
                  <input type="hidden" name="image" value="<?php echo $category_image; ?>" id="input-image" />
                </div>
              </div>
              <div class="form-group">
