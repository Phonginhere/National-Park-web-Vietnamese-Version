...
$manufacturer_total = manufacturerGetTotal();
...
paginate($manufacturer_total, $page,settings('config_limit_admin'), "/admin/manufacturer.php".$url);

// Nội dung riêng của trang...
$web_title = "Nhà Sản Xuất";
$web_content = "../ui/admin/view/view-manufacturer-list.php";
$active_page_admin = ACTIVE_PAGE_ADMIN_MANUFACTURER; // ACTIVE_PAGE_ADMIN_MANUFACTURER
