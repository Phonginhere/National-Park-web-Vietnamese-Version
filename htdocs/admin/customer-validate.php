...
function validateForm()
{
	...
	if(!preg_match('/^[0-9]{10,11}$/', $_POST['telephone']))
	{
		$error_phone = 'Số điện thoại phải chứa 10-11 chữ số !';
	}
	
	if ((utf8_strlen(trim($_POST['address'])) < 1))
	{
		$error_address = 'Bạn vui lòng nhập địa chỉ';
		return false;
	}
